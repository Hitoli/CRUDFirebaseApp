...
fun EditorScreen(onClickBack:()->Unit) {
    ...
    Scaffold(topBar = {
        TopAppBar( modifier = Modifier.padding(16.dp),title = { Text(text = "")}, navigationIcon = {
            ...
            if(!isSaveButton){
                ...
                Box(modifier = Modifier
                    ...
                    Icon(painter = painterResource(id = R.drawable.mode),
                        contentDescription = ConstantsOfProject.HomeScreenInfo,
                        tint = Color.White, modifier = Modifier.size(20.dp))
                }
            }
        ...
        Column(modifier = Modifier
            .fillMaxWidth()
            .padding(pad)) {
            BasicTextField(value = FirebaseDatabaseTitle.value, onValueChange = {Value->
                FirebaseDatabaseTitle.value = Value
                isTitleHintVisible = FirebaseDatabaseTitle.value.isEmpty()
            }, modifier = Modifier
                .fillMaxWidth()
                .padding(16.dp), textStyle = androidx.compose.
            ui.text.TextStyle(
                fontSize = 24.sp, fontWeight = FontWeight.Medium, color = Color.White
            ), cursorBrush = Brush.
            verticalGradient(colors = listOf(Color(0xFF2193b0), Color(0xFF6dd5ed))), enabled = !isSaveButton, decorationBox = {innerTexts->
            ...
            BasicTextField(value = FirebaseDatabaseContent.value, onValueChange = {Value->
                FirebaseDatabaseContent.value = Value
                isContentHintVisible = FirebaseDatabaseContent.value.isEmpty()
            }, modifier = Modifier.fillMaxWidth().padding(16.dp), textStyle = androidx.compose.
            ui.text.TextStyle(
                fontSize = 16.sp, fontWeight = FontWeight.Medium, color = Color.White
            ), cursorBrush = Brush.
            verticalGradient(colors = listOf(Color(0xFF2193b0), Color(0xFF6dd5ed))),enabled = !isSaveButton, decorationBox = {innerText->
